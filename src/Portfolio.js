...
function Portfolio() {
    ...
    return (
        <div className="bg-black text-green-300 font-mono min-h-screen flex flex-col items-center p-4">
            {/* Header Section */}
            ...
            <div className="w-full max-w-4xl flex justify-center mb-8">
                {sectionTitles.map((title) => (
                    ...
                    >
                        <span className="text-xl text-yellow-400 font-bold tracking-wide leading-tight inline-flex items-center gap-1">
                            {activeSection === title && (
